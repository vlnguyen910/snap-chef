...
export const RecipeForm = ({
  ...
  const [thumbnailPreview, setThumbnailPreview] = useState<string>(initialThumbnailPreview);
  const [thumbnailFile, setThumbnailFile] = useState<File | null>(null);
  const [stepImagePreviews, setStepImagePreviews] = useState<Record<number, string>>(initialStepImagePreviews);
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(handleSubmit)} className="min-h-screen bg-white py-8">
