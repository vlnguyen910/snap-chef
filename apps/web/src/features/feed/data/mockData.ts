...
export const MOCK_TOP_CHEFS: TopChef[] = [
  { id: '1', name: 'Chef Marcus', recipeCount: 120, avatar: 'https://i.pravatar.cc/150?img=11' },
  { id: '2', name: 'Chef Elena', recipeCount: 85, avatar: 'https://i.pravatar.cc/150?img=12' },
  { id: '3', name: 'John Pastry', recipeCount: 63, avatar: 'https://i.pravatar.cc/150?img=13' },
  { id: '4', name: 'Sofia Vegan', recipeCount: 47, avatar: 'https://i.pravatar.cc/150?img=14' },
];
