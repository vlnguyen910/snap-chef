...
export default function EditRecipePage() {
  ...
  const [initialStepImages, setInitialStepImages] = useState<Record<number, string>>({});
  ...
  const fetchRecipe = async () => {
    ...
    try {
      ...
      const formData: RecipeFormData = {
        ...
        })).sort((a: any, b: any) => a.order_index - b.order_index) || [{ order_index: 1, content: '' }],
      };
      ...
      response.steps?.sort((a: any, b: any) => (a.order_index || 0) - (b.order_index || 0)).forEach((step: any, index: number) => {
