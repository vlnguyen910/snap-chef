...
/**
  ...
  /**
   * `prisma.colleciton`: Exposes CRUD operations for the **Colleciton** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Collecitons
    * const collecitons = await prisma.colleciton.findMany()
    * ```
    */
  get colleciton(): Prisma.CollecitonDelegate<ExtArgs, { omit: OmitOpts }>;
}
